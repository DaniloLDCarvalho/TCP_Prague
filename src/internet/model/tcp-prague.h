 ...
 * @ingroup tcp
 *
 * @brief An implementation of Prague. This model implements all of the
 * endpoint capabilities mentioned in the Prague SIGCOMM paper.  Note that
...
class TcpPrague : public TcpLinuxReno
{
  public:
    /**
     ...
     *        This method will force PragueEcn mode and will force usage of
    ...
    /**
     * TracedCallback signature for Prague update of congestion state
     *
